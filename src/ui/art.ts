...
const ART: Record<string, string> = {
  ...
  // ---------------------------------------------------------- malzemeler
  pirinc: `
    <ellipse cx="24" cy="32" rx="14" ry="8" fill="${R.pirincGolge}"/>
    <path d="M10 30c0-8.5 6.3-14 14-14s14 5.5 14 14c0 2.6-2 4-5 4H15c-3 0-5-1.4-5-4z" fill="${R.pirinc}"/>
    <path d="M15 24c2.5-3.4 6-5 9-5" stroke="#fff" stroke-width="2" stroke-linecap="round" fill="none" opacity=".9"/>
    <circle cx="18" cy="31" r="1.2" fill="${R.pirincGolge}"/>
    <circle cx="27" cy="30" r="1" fill="${R.pirincGolge}"/>
    <circle cx="32" cy="32" r="1.1" fill="${R.pirincGolge}"/>
    <ellipse cx="14.5" cy="29.5" rx="2.6" ry="1.7" fill="${R.pembe}" opacity=".55"/>
    <ellipse cx="33.5" cy="29.5" rx="2.6" ry="1.7" fill="${R.pembe}" opacity=".55"/>`,

  nori: `
    <rect x="9" y="11" width="30" height="27" rx="6" fill="${R.noriKoyu}"/>
    <rect x="9" y="10" width="30" height="26" rx="6" fill="${R.nori}"/>
    <path d="M14 16h20M14 22h20M14 28h14" stroke="${R.noriKoyu}" stroke-width="1.6" stroke-linecap="round" opacity=".55"/>
    <path d="M13 14c3-1.5 6-1.5 9 0" stroke="#fff" stroke-opacity=".35" stroke-width="1.6" stroke-linecap="round" fill="none"/>`,

  cay: `
    <path d="M35 22h3.5a4.5 4.5 0 0 1 0 9H35" stroke="${R.seramikGolge}" stroke-width="3" fill="none" stroke-linecap="round"/>
    <path d="M12 19h24l-2.4 15.4A6 6 0 0 1 27.7 39h-7.4a6 6 0 0 1-5.9-4.6z" fill="${R.seramikGolge}"/>
    <path d="M12.6 18.6h22.8l-2.3 14.6a5.4 5.4 0 0 1-5.3 4.4h-7.6a5.4 5.4 0 0 1-5.3-4.4z" fill="${R.seramik}"/>
  ...
  dilim_somon: `
    <path d="M10.5 30.8c0-7.2 8.4-14.6 18.6-14.6 5.3 0 8.4 2.2 8.4 5.5 0 7.2-8.4 14.6-18.6 14.6-5.3 0-8.4-2.2-8.4-5.5z" fill="${R.somonKoyu}"/>
    <path d="M10.5 29.6c0-7.2 8.4-14.6 18.6-14.6 5.3 0 8.4 2.2 8.4 5.5 0 7.2-8.4 14.6-18.6 14.6-5.3 0-8.4-2.2-8.4-5.5z" fill="${R.somon}"/>
    <path d="M14.6 30.5c4-4.6 9-8.6 14.4-11M17 34.6c4-4.6 9-8.6 14.4-11M12.9 25.6c4-4.6 9-8.6 14.4-11" stroke="${R.somonCizgi}" stroke-width="2.1" stroke-linecap="round" fill="none"/>`,
  ...
  dilim_avokado: `
    <ellipse cx="24" cy="24.8" rx="13" ry="16" fill="${R.avokado}"/>
    <ellipse cx="24" cy="24" rx="13" ry="16" fill="${R.avokadoOrta}"/>
    <ellipse cx="24" cy="24" rx="10" ry="13" fill="${R.avokadoIc}"/>
    <circle cx="24" cy="26" r="5.6" fill="#B99378"/>
    <circle cx="24" cy="25.4" r="5.6" fill="${R.cekirdek}"/>
    <path d="M21.5 22.8c1.2-1 2.6-1.4 3.9-1.2" stroke="#fff" stroke-opacity=".5" stroke-width="1.5" stroke-linecap="round" fill="none"/>`,

  dilim_tamago: `
    <rect x="9" y="16" width="30" height="19" rx="5" fill="${R.tamagoKoyu}"/>
    <rect x="9" y="15" width="30" height="18" rx="5" fill="${R.tamago}"/>
    <path d="M12 21h24M12 26h24" stroke="${R.tamagoKoyu}" stroke-width="1.6" stroke-linecap="round" opacity=".8"/>
  ...
  // ---------------------------------------------------------- istasyonlar
  ist_pirinc: `
    <path d="M11 25c0-7.5 5.8-12 13-12s13 4.5 13 12z" fill="${R.pirincGolge}"/>
    <path d="M11.6 24c0-7 5.5-11.2 12.4-11.2S36.4 17 36.4 24z" fill="${R.pirinc}"/>
    <path d="M17 19.5c2.2-2.8 5-4.2 7.6-4.2" stroke="#fff" stroke-width="2" stroke-linecap="round" fill="none"/>
    <path d="M7 25h34c0 8.5-6.6 14-17 14S7 33.5 7 25z" fill="${R.seramikGolge}"/>
  ...
  ist_kesim_tamago: boardArt(`
    ...
    <path d="M32 26l7-9.5" stroke="${R.ahsapKoyu}" stroke-width="3.2" stroke-linecap="round"/>`),

  ist_nori: `
    <rect x="8" y="19" width="30" height="21" rx="5" fill="${R.noriKoyu}" opacity=".55"/>
    <rect x="10" y="15" width="30" height="21" rx="5" fill="${R.noriKoyu}"/>
    <rect x="10" y="14" width="30" height="20" rx="5" fill="${R.nori}"/>
    <path d="M15 20h20M15 25h20M15 30h13" stroke="${R.noriKoyu}" stroke-width="1.5" stroke-linecap="round" opacity=".6"/>`,

  ist_cay: `
    <path d="M37 22h3a4 4 0 0 1 0 8h-3" stroke="${R.seramikGolge}" stroke-width="3" fill="none" stroke-linecap="round"/>
    <ellipse cx="21" cy="28" rx="14" ry="11" fill="${R.seramikGolge}"/>
    <ellipse cx="21" cy="27" rx="14" ry="11" fill="${R.seramik}"/>
    <path d="M7 26c2 3 8 5 14 5s12-2 14-5" stroke="${R.seramikGolge}" stroke-width="1.8" fill="none" stroke-linecap="round"/>
  ...
  ist_mat: `
    <rect x="5" y="17" width="38" height="16" rx="4" fill="${R.ahsapKoyu}"/>
    <rect x="5" y="16" width="38" height="15" rx="4" fill="#EBD3A8"/>
    <path d="M11 16.5v14M16 16.5v14M21 16.5v14M26 16.5v14M31 16.5v14M36 16.5v14" stroke="${R.ahsapKoyu}" stroke-width="1.5" opacity=".55"/>
    <circle cx="38" cy="24" r="8" fill="${R.nori}"/>
    <circle cx="38" cy="23.4" r="5.4" fill="${R.pirinc}"/>
    <circle cx="38" cy="23.4" r="2.4" fill="${R.somon}"/>`,

  ist_atik: `
    <path d="M12 26h24l-2 12a4 4 0 0 1-4 3.4H18A4 4 0 0 1 14 38z" fill="${R.ahsapKoyu}"/>
    <path d="M12.6 25.6h22.8l-1.9 11.6a3.6 3.6 0 0 1-3.6 3H18.1a3.6 3.6 0 0 1-3.6-3z" fill="${R.ahsap}"/>
    <path d="M24 26c0-6 3.5-9.5 9-10-.5 6-3.5 9.5-9 10z" fill="${R.avokadoOrta}"/>
    <path d="M24 26c0-5-3-8-8-8.5.5 5 3 8 8 8.5z" fill="${R.avokado}"/>
    <path d="M24 26v-6" stroke="${R.avokado}" stroke-width="2" stroke-linecap="round"/>`,

  // ---------------------------------------------------------- karakterler
  kar_deniz: `
    <circle cx="24" cy="26" r="14" fill="${R.ten2}"/>
    <path d="M11 27c0 9.4 5.8 14 13 14s13-4.6 13-14c0-2.5-26-2.5-26 0z" fill="${R.sacAk}"/>
    <path d="M10 20c0-7.7 6.3-12 14-12s14 4.3 14 12z" fill="${R.gokyuzu}"/>
    <rect x="7" y="19" width="34" height="4" rx="2" fill="#8AA2C9"/>
    <circle cx="19" cy="25" r="1.7" fill="${R.murekkep}"/>
    <circle cx="29" cy="25" r="1.7" fill="${R.murekkep}"/>
    <path d="M20.5 30.5c2 1.6 5 1.6 7 0" stroke="${R.murekkep}" stroke-width="1.7" stroke-linecap="round" fill="none"/>`,

  kar_yaz: `
    <circle cx="24" cy="26" r="14" fill="${R.ten1}"/>
    <path d="M24 9c-9 0-15 6.6-15 15.6V31h4.6V22h20.8v9H39v-6.4C39 15.6 33 9 24 9z" fill="${R.sacKoyu}"/>
    <circle cx="19" cy="26" r="4" fill="none" stroke="${R.murekkep}" stroke-width="1.5" opacity=".8"/>
    <circle cx="29" cy="26" r="4" fill="none" stroke="${R.murekkep}" stroke-width="1.5" opacity=".8"/>
    <path d="M23 26h2" stroke="${R.murekkep}" stroke-width="1.4" opacity=".8"/>
    <circle cx="19" cy="26" r="1.5" fill="${R.murekkep}"/>
    <circle cx="29" cy="26" r="1.5" fill="${R.murekkep}"/>
    <path d="M21.5 32c1.6 1.2 4 1.2 5.6 0" stroke="${R.murekkep}" stroke-width="1.6" stroke-linecap="round" fill="none"/>`,

  kar_mira: `
    <circle cx="24" cy="26" r="14" fill="${R.ten1}"/>
    <path d="M10 25c0-9 6.2-14.6 14-14.6S38 16 38 25c-3-6-8-8.4-14-8.4S13 19 10 25z" fill="${R.sacKahve}"/>
    <circle cx="24" cy="8.4" r="5.4" fill="${R.sacKahve}"/>
    <path d="M18 6l8 4.4" stroke="${R.tamago}" stroke-width="2.2" stroke-linecap="round"/>
    <circle cx="19" cy="26" r="1.7" fill="${R.murekkep}"/>
    <circle cx="29" cy="26" r="1.7" fill="${R.murekkep}"/>
    <circle cx="15.5" cy="29" r="2.2" fill="${R.somon}" opacity=".5"/>
    <circle cx="32.5" cy="29" r="2.2" fill="${R.somon}" opacity=".5"/>
    <path d="M22 31.5c1.3 1.1 3.4 1.1 4.7 0" stroke="${R.murekkep}" stroke-width="1.6" stroke-linecap="round" fill="none"/>`,

  kar_kaptan: `
    <circle cx="24" cy="27" r="14" fill="${R.ten3}"/>
    <path d="M10.5 20c0-7.2 6-11.4 13.5-11.4S37.5 12.8 37.5 20z" fill="${R.seramik}"/>
    <rect x="7" y="19.4" width="34" height="4.4" rx="2.2" fill="${R.gokyuzu}"/>
    <circle cx="24" cy="14.6" r="3" fill="${R.gokyuzu}"/>
    <circle cx="19" cy="27" r="1.7" fill="${R.murekkep}"/>
    <circle cx="29" cy="27" r="1.7" fill="${R.murekkep}"/>
    <path d="M20.5 32.5h7" stroke="${R.murekkep}" stroke-width="1.7" stroke-linecap="round"/>`,

  kar_nen: `
    <path d="M11 18l1-9 8 5z" fill="#FFE7CC"/>
    <path d="M37 18l-1-9-8 5z" fill="#FFE7CC"/>
    <path d="M13.5 16.6l.6-4.8 4.3 2.7z" fill="${R.somon}" opacity=".7"/>
    <path d="M34.5 16.6l-.6-4.8-4.3 2.7z" fill="${R.somon}" opacity=".7"/>
    <circle cx="24" cy="26" r="14" fill="#FFEFD9"/>
    <path d="M16.4 25c1.6 1.8 4 1.8 5.6 0M26 25c1.6 1.8 4 1.8 5.6 0" stroke="${R.murekkep}" stroke-width="1.7" stroke-linecap="round" fill="none"/>
    <path d="M24 29.6l-1.8-1.6h3.6z" fill="${R.somon}"/>
    <path d="M24 29.6v1.6M24 31.2c-1 1.2-2.6 1.2-3.4 0M24 31.2c1 1.2 2.6 1.2 3.4 0" stroke="${R.murekkep}" stroke-width="1.4" stroke-linecap="round" fill="none"/>
    <path d="M9 26h5M9 29.5h5M34 26h5M34 29.5h5" stroke="${R.murekkep}" stroke-width="1.2" stroke-linecap="round" opacity=".45"/>`,

  kar_efe: `
    <circle cx="24" cy="26" r="14" fill="${R.ten1}"/>
    <path d="M11 22c0-8.4 5.8-13 13-13s13 4.6 13 13c-2.6-4.6-7.4-6.6-13-6.6S13.6 17.4 11 22z" fill="${R.sacKoyu}"/>
    <path d="M9.5 26v-3a14.5 14.5 0 0 1 29 0v3" stroke="${R.lavanta}" stroke-width="3" fill="none" stroke-linecap="round"/>
    <rect x="6.5" y="24" width="6.5" height="10" rx="3.2" fill="${R.lavanta}"/>
    <rect x="35" y="24" width="6.5" height="10" rx="3.2" fill="${R.lavanta}"/>
    <circle cx="19.5" cy="26.5" r="1.7" fill="${R.murekkep}"/>
    <circle cx="28.5" cy="26.5" r="1.7" fill="${R.murekkep}"/>
    <path d="M21 31.6c1.4 1 3.6 1 5 0" stroke="${R.murekkep}" stroke-width="1.6" stroke-linecap="round" fill="none"/>`,


  // ---------------------------------------------------------- yeni malzemeler
  ikura: `
    <ellipse cx="24" cy="30" rx="14" ry="8" fill="${R.noriKoyu}"/>
  ...
  tofu: `
    ...
    <ellipse cx="24" cy="20" rx="5" ry="2.2" fill="${R.pirinc}" opacity=".9"/>`,

  miso: `
    <path d="M10 22h28l-2.6 13.6A6 6 0 0 1 29.5 40h-11a6 6 0 0 1-5.9-4.4z" fill="${R.ahsapKoyu}"/>
    <path d="M10.6 21.6h26.8l-2.5 13a5.4 5.4 0 0 1-5.3 4.4h-11a5.4 5.4 0 0 1-5.3-4.4z" fill="${R.ahsap}"/>
  ...
  mochi: `
    ...
    <ellipse cx="13.5" cy="29" rx="2.4" ry="1.6" fill="${R.pembe}" opacity=".7"/>
  ...
  ist_miso: `
    ...
    <path d="M8.6 20.6h30.8l-2.9 15A6.4 6.4 0 0 1 30 41H18a6.4 6.4 0 0 1-6.3-5.4z" fill="${R.ahsap}"/>
  ...
  ist_tofu: `
    <rect x="6" y="28" width="36" height="9" rx="4.5" fill="${R.ahsapKoyu}"/>
    <rect x="6" y="26.5" width="36" height="8.5" rx="4.2" fill="${R.ahsap}"/>
    ...
    <path d="M32 24l7-4.4" stroke="${R.ahsapKoyu}" stroke-width="3" stroke-linecap="round"/>`,

  ist_mochi: `
    <ellipse cx="24" cy="33" rx="17" ry="7" fill="${R.ahsap}"/>
    ...
    <path d="M24 14l3 5h-6z" fill="${R.somon}" opacity=".8"/>`,

  yemek_sashimi: `
    <ellipse cx="24" cy="32" rx="18" ry="8" fill="${R.seramikGolge}"/>
    <ellipse cx="24" cy="30.6" rx="18" ry="8" fill="${R.seramik}"/>
    <path d="M8 27c0-4.4 5.4-9 12-9 3.4 0 5.4 1.4 5.4 3.6 0 4.4-5.4 9-12 9C10 30.6 8 29.2 8 27z" fill="${R.somonKoyu}"/>
    <path d="M8 26c0-4.4 5.4-9 12-9 3.4 0 5.4 1.4 5.4 3.6 0 4.4-5.4 9-12 9C10 29.6 8 28.2 8 26z" fill="${R.somon}"/>
    <path d="M11 26c2.6-3 5.8-5.4 9-6.8" stroke="${R.somonCizgi}" stroke-width="1.8" stroke-linecap="round" fill="none"/>
    <path d="M22 29c0-4.2 5-8.6 11.2-8.6 3.2 0 5 1.4 5 3.4 0 4.2-5 8.6-11.2 8.6-3.2 0-5-1.4-5-3.4z" fill="${R.somonKoyu}"/>
    <path d="M22 28c0-4.2 5-8.6 11.2-8.6 3.2 0 5 1.4 5 3.4 0 4.2-5 8.6-11.2 8.6-3.2 0-5-1.4-5-3.4z" fill="${R.somon}"/>
    <path d="M25 28c2.4-2.8 5.4-5 8.4-6.4" stroke="${R.somonCizgi}" stroke-width="1.7" stroke-linecap="round" fill="none"/>
    <path d="M40 34c-2-2-3-4.4-3-7" stroke="${R.avokado}" stroke-width="2" stroke-linecap="round" fill="none"/>`,
  ...
  yemek_inari: `
    ...
    <ellipse cx="24" cy="21" rx="7" ry="2.6" fill="${R.pirinc}"/>
    <circle cx="21" cy="20.6" r="1" fill="${R.pirincGolge}"/><circle cx="26" cy="21.2" r="1" fill="${R.pirincGolge}"/>`,

  yemek_gunkan: `
    <ellipse cx="24" cy="36" rx="14" ry="5" fill="${R.pirincGolge}"/>
    <rect x="10" y="18" width="28" height="18" rx="6" fill="${R.noriKoyu}"/>
    <rect x="10" y="17" width="28" height="18" rx="6" fill="${R.nori}"/>
    <rect x="12.4" y="19.6" width="23.2" height="13" rx="4" fill="${R.pirinc}" opacity=".25"/>
  ...
  // ---------------------------------------------------------- zengin malzemeler
  dilim_karides: `
    <path d="M33 13.6c3.6.4 5.8 2.4 6.6 6-2.8-1.6-5-2.2-6.6-1.8z" fill="${R.karidesKoyu}"/>
    <path d="M12 26c0-7.2 6.8-13 15.4-13 4.4 0 6.8 2 6.8 5.4 0 2.6-1.4 5.4-3.8 7.8 3 .6 4.8 2.4 5 5.2-3.4-2-6.6-2.6-9.6-1.8-2.6 2-5.6 3.2-8.6 3.2-3.4 0-5.2-2.2-5.2-6.8z" fill="${R.karidesKoyu}"/>
    <path d="M12 24.8c0-7.2 6.8-13 15.4-13 4.4 0 6.8 2 6.8 5.4 0 2.6-1.4 5.4-3.8 7.8 3 .6 4.8 2.4 5 5.2-3.4-2-6.6-2.6-9.6-1.8-2.6 2-5.6 3.2-8.6 3.2-3.4 0-5.2-2.2-5.2-6.8z" fill="${R.karides}"/>
    <path d="M16.6 17.6c1.6 3.4 1.8 7 .6 10.8M21.8 14.6c1.8 3.8 2 7.8.8 11.8M27 13.2c1.8 3.6 2 7.2.8 10.8" stroke="${R.karidesCizgi}" stroke-width="2" stroke-linecap="round" fill="none"/>
    <circle cx="14.8" cy="23.4" r="1.8" fill="#fff" opacity=".75"/>
    <circle cx="31" cy="16" r="1.1" fill="#fff" opacity=".6"/>`,

  dilim_yilanbaligi: `
    <path d="M9 27.6c0-5.6 7-11.6 17-11.6 5.4 0 8.4 2 8.4 5 0 5.6-7 11.6-17 11.6-5.4 0-8.4-2-8.4-5z" fill="${R.unagiKoyu}"/>
    <path d="M9 26.4c0-5.6 7-11.6 17-11.6 5.4 0 8.4 2 8.4 5 0 5.6-7 11.6-17 11.6-5.4 0-8.4-2-8.4-5z" fill="${R.unagi}"/>
    <path d="M11.6 24.6c4.4-3.8 9.6-6.6 15.2-8M13.4 28.6c4.4-3.8 9.6-6.6 15.2-8M15.6 31.6c4-3.4 8.6-6 13.6-7.4" stroke="${R.unagiSos}" stroke-width="2.2" stroke-linecap="round" fill="none" opacity=".55"/>
  ...
  dilim_salatalik: `
    <circle cx="17" cy="27" r="9.6" fill="${R.salatalikKoyu}"/>
    <circle cx="17" cy="26.2" r="9.6" fill="${R.salatalik}"/>
    <circle cx="17" cy="26.2" r="6.8" fill="#E4F6D4"/>
    <path d="M17 20.6v11M12 24.4l10 3.6M22 24.4l-10 3.6" stroke="${R.salatalikKoyu}" stroke-width="1.2" stroke-linecap="round" opacity=".7"/>
    <circle cx="32" cy="22" r="8" fill="${R.salatalikKoyu}"/>
    <circle cx="32" cy="21.2" r="8" fill="${R.salatalik}"/>
    <circle cx="32" cy="21.2" r="5.6" fill="#E4F6D4"/>
    <path d="M32 16.6v9.2M28 19.2l8 3M36 19.2l-8 3" stroke="${R.salatalikKoyu}" stroke-width="1.1" stroke-linecap="round" opacity=".7"/>`,

  dilim_mango: `
    <path d="M11 28c0-6.4 6.6-12.4 15-12.4 5 0 8 2.4 8 5.8 0 6.4-6.6 12.4-15 12.4-5 0-8-2.4-8-5.8z" fill="${R.mangoKoyu}"/>
  ...
  krem_peynir: `
    <path d="M11 21.4l13-6.4 13 6.4v11.2l-13 6.4-13-6.4z" fill="${R.kremKoyu}"/>
    <path d="M11 21.4l13 6.4 13-6.4-13-6.4z" fill="#FFFDF6"/>
    <path d="M24 27.8v11.2l-13-6.4V21.4z" fill="${R.krem}"/>
    <path d="M37 21.4v11.2l-13 6.4V27.8z" fill="#F3E4CC"/>
    <path d="M15.4 22.6c3 2 5.8 3 8.6 3s5.6-1 8.6-3" stroke="${R.kremKoyu}" stroke-width="1.2" fill="none" stroke-linecap="round"/>
    <ellipse cx="19" cy="19.6" rx="3.4" ry="1.7" fill="#fff" opacity=".9"/>
    <ellipse cx="16" cy="30" rx="2.2" ry="1.5" fill="${R.pembe}" opacity=".5"/>
    <ellipse cx="32" cy="30" rx="2.2" ry="1.5" fill="${R.pembe}" opacity=".45"/>`,

  tempura: `
    <path d="M31.4 15.4c2.8-2 5.4-1.6 7.6 1.2-2.8.6-5 1.4-6.6 2.6z" fill="${R.karides}"/>
    <path d="M13 27.4c-.4-3 .6-5.6 3-7.8-.6-3 .6-5.2 3.6-6.4 1.6-2.4 3.8-3.2 6.6-2.4 2.8-1 5-.4 6.6 2 3 .8 4.4 2.8 4.2 5.8 2 2.2 2.4 4.6 1.2 7.2.8 3-.2 5.2-3 6.6-1 2.8-3 4-6 3.6-2.4 1.8-4.8 1.8-7.2 0-3 .4-5-.8-6-3.6-2.6-1.4-3.6-3.4-3-5z" fill="${R.tempuraKoyu}"/>
  ...
  kar_poyraz: `
    ...
    <circle cx="19" cy="26.5" r="1.7" fill="${R.murekkep}"/>
    <circle cx="29" cy="26.5" r="1.7" fill="${R.murekkep}"/>
    <path d="M20.6 32c2 1.7 4.8 1.7 6.8 0" stroke="${R.murekkep}" stroke-width="1.7" stroke-linecap="round" fill="none"/>
    <path d="M33 33l6 6" stroke="${R.ahsapKoyu}" stroke-width="3" stroke-linecap="round"/>
    <ellipse cx="39.5" cy="40" rx="4" ry="3.4" fill="${R.ahsap}"/>`,

  kar_ada: `
    <circle cx="24" cy="27" r="13" fill="${R.ten1}"/>
    <path d="M11.5 25c0-8.4 5.6-13.4 12.5-13.4S36.5 16.6 36.5 25c-2.4-4.6-7-6.6-12.5-6.6S13.9 20.4 11.5 25z" fill="${R.sacKahve}"/>
    <circle cx="11" cy="22" r="4" fill="${R.sacKahve}"/><circle cx="37" cy="22" r="4" fill="${R.sacKahve}"/>
    <circle cx="11" cy="22" r="2" fill="${R.somon}"/><circle cx="37" cy="22" r="2" fill="${R.somon}"/>
    <circle cx="19.5" cy="27" r="2" fill="${R.murekkep}"/>
    <circle cx="28.5" cy="27" r="2" fill="${R.murekkep}"/>
    <circle cx="20" cy="26.3" r=".7" fill="#fff"/><circle cx="29" cy="26.3" r=".7" fill="#fff"/>
    <path d="M21 32.4c1.6 2 4.4 2 6 0" stroke="${R.murekkep}" stroke-width="1.7" stroke-linecap="round" fill="none"/>
    <circle cx="15.5" cy="30.5" r="2.2" fill="${R.somon}" opacity=".55"/>
    <circle cx="32.5" cy="30.5" r="2.2" fill="${R.somon}" opacity=".55"/>`,
  ...
  ruh_giden: `<path d="M38 10C22 10 10 18 10 30c0 4 2 8 2 8s10-2 16-8 10-14 10-20z" fill="${R.avokadoOrta}"/><path d="M34 14C26 20 18 28 13 37" stroke="${R.avokado}" stroke-width="2" stroke-linecap="round" fill="none"/>`,
  ...
  ui_fener: `
    ...
    <path d="M24 11c8.2 0 13.4 5.6 13.4 13.2S32.2 37.4 24 37.4 10.6 31.8 10.6 24.2 15.8 11 24 11z" fill="${R.tamagoKoyu}"/>
    <path d="M24 11.8c7.7 0 12.6 5.3 12.6 12.4S31.7 36.6 24 36.6s-12.6-5.3-12.6-12.4S16.3 11.8 24 11.8z" fill="${R.tamago}"/>
    <path d="M17.6 14.6c-1.5 2.6-2.3 5.8-2.3 9.6s.8 7 2.3 9.6M30.4 14.6c1.5 2.6 2.3 5.8 2.3 9.6s-.8 7-2.3 9.6" stroke="${R.somonKoyu}" stroke-width="1.7" fill="none" opacity=".8"/>
    <ellipse cx="24" cy="24" rx="4.2" ry="6" fill="#FFF3D6"/>
    <rect x="15" y="36" width="18" height="3.6" rx="1.8" fill="${R.ahsapKoyu}"/>
    <path d="M22 40h4l-1 4.4h-2z" fill="${R.somon}"/>`,
  ui_takvim: `
    <rect x="7" y="11" width="34" height="30" rx="6" fill="${R.lavanta}"/>
    ...
    <circle cx="24" cy="34" r="2.6" fill="${R.somon}"/>`,
  ui_tabak: `
    <ellipse cx="24" cy="28" rx="17" ry="9" fill="${R.seramikGolge}"/>
    <ellipse cx="24" cy="26.6" rx="17" ry="9" fill="${R.seramik}"/>
    <ellipse cx="24" cy="26.2" rx="11" ry="5.4" fill="${R.seramikGolge}" opacity=".6"/>
    <path d="M9 14l4 8M15 12l2 9" stroke="${R.ahsapKoyu}" stroke-width="2.2" stroke-linecap="round"/>`,
  ui_ay: `
    <path d="M30 6a18 18 0 1 0 12 30A20 20 0 0 1 30 6z" fill="${R.tamago}"/>
    <circle cx="15" cy="19" r="2.4" fill="${R.tamagoKoyu}" opacity=".6"/>
    <circle cx="21" cy="30" r="1.8" fill="${R.tamagoKoyu}" opacity=".5"/>`,
  ui_jeton: `
  ...
  ui_parilti: `
    ...
    <path d="M38 32l1.8 4.4L44 38l-4.2 1.6L38 44l-1.8-4.4L32 38l4.2-1.6z" fill="${R.somon}"/>`,
...
export const INGREDIENT_COLORS: Record<string, [string, string]> = {
  ...
  tofu: ["#F5E6C4", "#D9BE86"],
  mochi: ["#FFF0F3", "#F5C9D4"],
  pirinc: [R.pirinc, R.pirincGolge],
  nori: [R.nori, R.noriKoyu],
  cay: [R.matcha, "#8FB868"],
  miso: ["#DCA765", "#C98F4E"],
  dilim_karides: [R.karides, R.karidesKoyu],
  dilim_yilanbaligi: [R.unagi, R.unagiKoyu],
  dilim_salatalik: [R.salatalik, R.salatalikKoyu],
  dilim_mango: [R.mango, R.mangoKoyu],
  ...
  maki_mango: [R.mango, R.mangoKoyu],
  maki_karides: [R.karides, R.karidesKoyu],
  maki_krem: [R.krem, R.kremKoyu],
  maki_tempura: [R.tempura, R.tempuraKoyu],
};
...
const GARNISH_MOTIF: Record<string, string> = {
  ...
  limon: `<path d="M-4.6 2.4A5.4 5.4 0 0 1 4.6 2.4z" fill="#FFE9A0"/><path d="M-3.4 2.2A4.2 4.2 0 0 1 3.4 2.2z" fill="#FFF4CE"/><path d="M0 2.2v-4M0 2.2l-2.6-3M0 2.2l2.6-3" stroke="#F2CF74" stroke-width=".8" stroke-linecap="round"/>`,
  nori_serit: `<rect x="-7" y="-2.6" width="14" height="5.2" rx="1.4" fill="${R.nori}"/><rect x="-7" y="-2.6" width="14" height="1.6" rx=".8" fill="#A3D0C7"/>`,
};
...
export function customRecipeArt(
  ...
  const katmanlar = renkler.length ? renkler : [[R.somon, R.somonKoyu] as [string, string]];
  let govde: string;
  ...
  if (base === "nigiri") {
    ...
    govde = `
      ...
      <ellipse cx="24" cy="33.6" rx="15.5" ry="7" fill="${R.pirinc}"/>
      <circle cx="17" cy="35.4" r="1" fill="${R.pirincGolge}"/>
    ...
    govde = `
      <ellipse cx="24" cy="36" rx="14" ry="5" fill="${R.pirincGolge}"/>
      <rect x="10" y="19" width="28" height="17" rx="6" fill="${R.noriKoyu}"/>
...
const HAIR_BACK: Record<string, (sc: string) => string> = {
  ...
  at_kuyrugu: (sc) => `<path d="M32 12c4.6 1.6 6.6 5.4 6 11.4-.6 5.6-3 8.6-7.2 9 2.6-3.4 3.6-6.8 3-10.2-.6-3.4-1.2-6.8-1.8-10.2z" fill="${sc}"/>`,
  kisa: () => "",
  dagitik: () => "",
};
